...
*Source: worker/pipeline/wiki_planner.py:1-75, worker/pipeline/page_generator.py:10-50*
...
*Source: worker/pipeline/wiki_planner.py:89-111, 531-601*
...
*Source: worker/utils/mermaid.py:15-60, tests/worker/test_mermaid_sanitize.py:20-80*
...
*Source: worker/pipeline/diagram_post_processor.py:10-45, tests/worker/test_mermaid_sanitize.py:85-120*
...
1.  **用户导向格式 (`to_wiki_json`)**
    ...
    *   *Source: worker/pipeline/wiki_planner.py:207-239*
...
2.  **内部状态格式 (`to_internal_json`)**
    ...
    *   *Source: worker/pipeline/wiki_planner.py:241-271*
...
3.  **API 响应格式 (`to_api_structure`)**
    ...
    *   *Source: worker/pipeline/wiki_planner.py:273-308*
...
*Source: worker/pipeline/wiki_planner.py:79-86*
