...
*Source: [worker/pipeline/page_generator.py:143-307](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/page_generator.py#L143-L307), [worker/pipeline/fact_check.py:149-195](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/fact_check.py#L149-L195)*
...
| 类/属性 | 类型 | 说明 |
| :--- | :--- | :--- |
| [`FactCheckIssue.claim`](https://github.com/lazyxiang/AutoWiki/blob/main/FactCheckIssue.claim) | `str` | 被认定为错误的具体陈述或事实声称。 |
| [`FactCheckIssue.reason`](https://github.com/lazyxiang/AutoWiki/blob/main/FactCheckIssue.reason) | `str` | 核查失败的原因，通常是与源代码不一致的说明。 |
| [`FactCheckIssue.section`](https://github.com/lazyxiang/AutoWiki/blob/main/FactCheckIssue.section) | `str | None` | 错误发生的 Markdown 标题（可选），用于精准定位。 |
| [`FactCheckIssue.diagram_index`](https://github.com/lazyxiang/AutoWiki/blob/main/FactCheckIssue.diagram_index) | `int | None` | 如果是 Mermaid 图表错误，记录其在页面中的索引。 |
| [`FactCheckResult.verdict`](https://github.com/lazyxiang/AutoWiki/blob/main/FactCheckResult.verdict) | `str` | 核查定论，可选值为 `"pass"` 或 `"fail"`。 |
| [`FactCheckResult.issues`](https://github.com/lazyxiang/AutoWiki/blob/main/FactCheckResult.issues) | `list[FactCheckIssue]` | 包含所有发现的错误列表。 |

*Source: [worker/pipeline/fact_check.py:54-66](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/fact_check.py#L54-L66)*
...
*Source: [worker/pipeline/fact_check.py:69-83](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/fact_check.py#L69-L83), 149-195*
...
*Source: [worker/pipeline/fact_check.py:212-302](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/fact_check.py#L212-L302), 323-411*
...
*Source: [worker/pipeline/fact_check.py:323-411](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/fact_check.py#L323-L411)*
...
*Source: [worker/pipeline/page_outline.py:119-203](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/page_outline.py#L119-L203), 257-317*
...
*Source: [worker/pipeline/page_generator.py:49-60](https://github.com/lazyxiang/AutoWiki/blob/main/worker/pipeline/page_generator.py#L49-L60), 224-254*
...
| [`tests/worker/test_fact_check.py`](https://github.com/lazyxiang/AutoWiki/blob/main/tests/worker/test_fact_check.py) |
