...
*Source: [shared/models.py:13-112](https://github.com/lazyxiang/AutoWiki/blob/main/shared/models.py#L13-L112)*

在 `worker/jobs.py` 中，Worker 节点订阅 Redis 队列并执行具体的 Python 函数。任务执行过程中，Worker 会频繁调用数据库更新函数，确保前端可以通过 API 实时获取任务的最细粒度状态。

*Source: [worker/jobs.py:285-300](https://github.com/lazyxiang/AutoWiki/blob/main/worker/jobs.py#L285-L300)*
...
*Source: [worker/jobs.py:285-1389](https://github.com/lazyxiang/AutoWiki/blob/main/worker/jobs.py#L285-L1389)*
...
*Source: [worker/jobs.py:285-693](https://github.com/lazyxiang/AutoWiki/blob/main/worker/jobs.py#L285-L693), [shared/database.py:14-33](https://github.com/lazyxiang/AutoWiki/blob/main/shared/database.py#L14-L33)*
...
*Source: [worker/jobs.py:139-177](https://github.com/lazyxiang/AutoWiki/blob/main/worker/jobs.py#L139-L177)*
...
*Source: [worker/jobs.py:66-131](https://github.com/lazyxiang/AutoWiki/blob/main/worker/jobs.py#L66-L131), 139-177, 180-214, 273-277*
...
*Source: [worker/jobs.py:113-131](https://github.com/lazyxiang/AutoWiki/blob/main/worker/jobs.py#L113-L131)*
